# Full-roster regression audit — 0.10.4
...
- Source database: 0.10.4; data schema 13; local roster schema 5.
...
- Recorded audit runtime: 21752 ms.
...
The 0.10.3 deterministic hash was `ca8d09e060d7b28faa44115f65d2cfe52b1cce2ecc1a9a5fc9439714e22afc48`; the 0.10.4 hash is `ca8d09e060d7b28faa44115f65d2cfe52b1cce2ecc1a9a5fc9439714e22afc48`. All 26,970 numeric scores and component totals unchanged: Yes.

## Browser QA

Status: PASS. Audited URL: http://127.0.0.1:4173/ (local 0.10.4 production preview). Fixture: isolated localhost with an empty local roster; no production account or roster used. Dragon-detail overflow: 0; clipped interactive controls: 0; console errors: 0; console warnings: 0.
