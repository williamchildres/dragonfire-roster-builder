...
New Moon records Rounds 1/3/5 Rising Tide probabilities 25/30/35/42.5/50%, doubled by any Ally's Advantage to 50/60/70/85/100%. Its odd-round one-other-Sentinel support records Instinct 9/10.8/12.6/15.3/18% and Tactical Damage 6/7.2/8.4/10.2/12%, with a generic 1.5x magnitude modifier at 4+ Rising Tide. The verified enhancement is Initiative, not Instinct, and creates Moondancer's Initiative payoff from the 2-Star unlock only when at least one other allied Sentinel is present. This is a beneficiary-mechanic formation requirement: the Initiative provider need not be a Sentinel, and multiple eligible Sentinels preserve the payoff even when recipient identity remains unresolved. New Moon selection is independent from Crescent Blade selection.
...
Generic `magnitude-uplift`, `stackFacts`, `targetSelectorEvidence`, and `battleStateComparisonEvidence` preserve exact modifiers, thresholds, caps, comparisons, and unresolved scope for technical analysis. They do not modify Formation Rating base values or optimizer weights.
...
The reusable `other-ally-breed-present` signal requirement gates New Moon's Initiative candidate on another allied Sentinel without using provider selection or requiring unique recipient resolution. At 10 Stars with no Sentinel, Eclipsing Strike remains the sole Initiative candidate and retains its chance-based 20%/40% unresolved probability context. With a Sentinel, both candidates may be traced but one numeric Initiative relationship is scored.
...
- Interim corrected 0.23.5 placement snapshot: 35,904 rows, `sha256:4e695d5c106bec70174afbe673d562da51c52c31844aabb07fb97b53c4cb7a4d`
- Final corrected 0.23.5 placement snapshot: 35,904 rows, `sha256:423ee44d186ff842db5d500306c20a191bba13a4bfd25b5927159c1998766193`
- Existing 33-dragon placements compared: 32,736
- Existing placements changed: 0
- New Moondancer placements: 3,168
- Moondancer placements changed by the final correction: 1,593 (interim correction: 2,001)
- Placements changed specifically by suppressing invalid no-Sentinel New Moon Initiative credit: 1,095
- Correction-delta manifest: `sha256:281078aa16075eff4c7178dacdf32aa164e6321cb069b71a8077053c4bd52430`
- Catalog-delta manifest: `sha256:1601e7a442426190a0567174ef5da766b90b1dcd31006fd831bacf6435ce2b09`
- New-row numeric identity: `sha256:139b75330f380602eda10afc2b838cf5f5bcab4dbd7fcbec72272ff9de47af29`

Current identities:

- Formation Rating v3 contract: `9ea93aaaac6edaf830410d59f23d88f473b30a4e41ce032a7decb260592ad01a` (previous corrected head: `b22afa9e530c0c7319d5cc4a26f1b253afcaece30277681961708c9de33041ab`; original PR head: `1e6e021e2bdfb79e83a041866754fef931484c0726d9e5051a62b314c749238f`)
- Formation Rating v3 numeric: `939b488ea17aac779b16c1313f6759f0bea76e0a7d9182c09f2fe32f3e9d5f86` (previous corrected head: `632ff1710d9f0a4634127f09fd3bb4b58d545bb6705b23d84316b3519846e862`; original PR head: `c04d9541a4c4b0c5b202ebc2be703f5832db3b8a5d0b4b77087ac647d5cf0976`)
- Formation Rating v3 audit: `abaf4ebab4ef6da6796183578f005983082343f93577e0d4b211ef422cd82efd` (previous corrected head: `a04501adc7ed9d7f31a3e149fce23223500dfd741afa4459b086f78c4db4cc21`; original PR head: `9a33851670be326ac05be85b2096ad165b3c0c1c83c4019a5178d9045484292f`)
- Reliability research: `332856d0d08eaf8922b589d28c8c521c2a2ba3d1e329881ee9137667bdf11ba0` (previous corrected head: `d2b662b302414611ab4bb03a0997f592fdb4482a79d6a191d6f26bd89977af21`; original PR head: `e01d0e4e99afcc1771dabcaf6289ebd616877ff4ed53cd3e32f4e78ee1fbfcde`)
- Reliability registry: `246bbef69594d91df916378e5a92755392108caff8b659b8ea977c1535480d6e` (previous corrected head: `3c995038f50606d9dc6470976021e1c717c1963ebb21c782455c78cf9652fab0`; original PR head: `c77c5dbe00eeecfc3d8506f47f4c327bccbb52327b413ff5119d91bec9b2334b`)
...
- Optimizer audit identity: `fnv1a64:701d3db5f5e41ffe` (previous corrected head: `fnv1a64:38b92faea349b548`; original PR head: `fnv1a64:4919638a23435778`)
- 0.23.4 → 0.23.5 release delta: 198 execution records, `sha256:ec76aba971390ed6f8b603b112987067d63886c158fb561a79ba617281da897d`
...
- At 2 Stars with Caraxes in Vanguard and no allied Sentinel, Caraxes' Initiative support is visible but does not create a New Moon relationship to Moondancer.
- At 2 Stars with a Sentinel present, the Initiative payoff is active. The Advantage explanation shows New Moon's 25/30/35/42.5/50% to 50/60/70/85/100% uplift only.
- At 6 Stars, the same single Advantage relationship also explains Full Moon's identical uplift; the downstream rolls remain probabilistic.
- At 10 Stars without a Sentinel, Caraxes to Moondancer Initiative support selects Eclipsing Strike, remains unquantified with its 20%/40% probability contexts, and receives zero numeric contribution.
- At 10 Stars with a Sentinel, New Moon is the fully reliable selected candidate, Eclipsing Strike remains retained evidence, and only one Initiative relationship is scored for each provider-beneficiary pair.
- Vhagar's browser explanation remains 25% ordinary Taunt to 50% Burn-conditioned Taunt, explicitly stating that the resulting activation remains probabilistic.
- The production build emitted zero console warnings and zero console errors across the acceptance cases.
