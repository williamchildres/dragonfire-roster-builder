# Full-roster regression audit — 0.10.3
...
- Source database: 0.10.3; data schema 13; local roster schema 5.
...
- Recorded audit runtime: 18196 ms.
...
The 0.10.2 deterministic hash was `b8e09b1ea60476aa9ea368636a936cc09534b67ea0f294ed3589cf583e845c41`; the 0.10.3 hash is `ca8d09e060d7b28faa44115f65d2cfe52b1cce2ecc1a9a5fc9439714e22afc48`. All 26,970 numeric scores and component totals unchanged: No.

## Browser QA

Status: PASS. Audited URL: http://127.0.0.1:4173/ (local 0.10.3 production preview). Fixture: isolated localhost with an empty local roster; no production account or roster used. Dragon-detail overflow: 0; clipped interactive controls: 0; console errors: 0; console warnings: 0.
