...
The optimizer-v6 audit independently solves 3 fixtures × 3 modes × 11 counts × 2 input orders: 198 records, 198 solver executions, and six independent candidate-pool builds. Current Strongest First and Balanced selections are compared with the immutable optimizer-v5 artifact. The 0.23.3 Blazing Fury correction has an exact committed 50-entry approved-delta manifest with identity `sha256:7630e354700b908f4e3c86379552a2c13b9e6d1034a0fdaa011772cd4eaff69a`; each entry fixes the fixture/mode/count/order key plus historical and current stable keys, power/rating vectors, and solution/result hashes. An expected delta disappearing, an unexpected delta appearing, a vector/hash changing differently, a duplicate execution key, or any unapproved drift fails the audit. Best Overall is absent because optimizer v5 has no historical Best Overall baseline. The historical v5 artifact and `fnv1a64:e5ac2432442f5cb0` identity remain untouched.
