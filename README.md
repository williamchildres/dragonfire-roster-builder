...
Formation Builder opens in `All 10 Star Dragons` mode for sandbox planning with every selectable dragon shown as Star 10. `Roster Dragons` mode restricts choices to owned roster dragons and uses saved roster progression where the current builder supports it.
