...
const regressionCases: Array<{
  ...
  { label: 'Malachite / Venator / Vermax', formation: { 'left-flank': 'malachite', vanguard: 'venator', 'right-flank': 'vermax' }, dragonLevels: { malachite: 26, venator: 26, vermax: 26 }, expectedCounts: { active: 24, potential: 32, inactive: 9, blocked: 1, unknown: 1, 'not-applicable': 1, total: 68 }, expectedCards: ['malachite:8/9', 'venator:10/4', 'vermax:6/5'] },
